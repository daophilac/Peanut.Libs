...
namespace Peanut.Libs.Specialized {
    /// <summary>
    /// Controls audio using the Windows CoreAudio API.<br/>
    ...
    public static class AudioManager {
        ...
        /// <summary>
        /// Gets the current master volume in scalar values (percentage).<br/>
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Gets the mute state of the master volume.<br/>
        /// While the volume can be muted the <see cref="GetMasterVolume"/>
        /// will still return the pre-muted volume value.<br/>
        /// </summary>
        /// <returns>
        /// <see langword="false"/> if not muted, <see langword="true"/> if volume is muted.
        /// </returns>
        ...
        /// <summary>
        /// Increments or decrements the current volume level by the <paramref name="stepAmount"/>.<br/>
        /// </summary>
        /// <param name="stepAmount">
        ///     Value between -100 and 100 indicating the desired step amount.
        ///     Use negative numbers to decrease the volume and positive numbers to increase it.
        /// </param>
        ...
        /// </summary>
        /// <param name="isMuted">
        ///     <see langword="true"/> to mute the master volume, <see langword="false"/> to unmute.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        /// The current mute state, <see langword="true"/> if the volume was muted,
        /// <see langword="false"/> if unmuted.
        /// </returns>
        ...
        /// <summary>
        /// Gets an application volume in scalar values (percentage).<br/>
        /// </summary>
        /// <param name="pid">The process's id.</param>
        /// <returns>
        /// <see langword="null"/> if the <paramref name="pid"/> could not be found,
        /// otherwise the value will be between 0 and 100.
        /// </returns>
        ...
        /// <summary>
        /// Gets the mute state of an application.<br/>
        /// </summary>
        /// <param name="pid">The process's id.</param>
        /// <returns>
        /// <see langword="null"/> if the <paramref name="pid"/> could not be found.
        /// Otherwise <see langword="false"/> if not mute, <see langword="true"/> if muted.
        /// </returns>
        ...
        /// <summary>
        /// Sets an application volume to a specific level.<br/>
        /// </summary>
        /// <param name="pid">The process's id.</param>
        /// <param name="level">
        ///     Value between 0 and 100 indicating the desired scalar value of the volume.
        ...
        /// <summary>
        /// Mute or unmute an application volume.<br/>
        /// </summary>
        /// <param name="pid">The process's id.</param>
        /// <param name="mute">
        ///     <see langword="true"/> to mute the master volume, <see langword="false"/> to unmute.
