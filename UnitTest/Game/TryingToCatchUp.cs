...
namespace UnitTest.Game {
    internal class TryingToCatchUpGame : Peanut.Libs.Game.Game {
        public TryingToCatchUpGame() {
        ...
        protected override void Update(GameTime gameTime) {
            ...
            if (Count == 2) {
                Console.WriteLine($"{nameof(ResetElapsedTime)}");
                ResetElapsedTime();
                Count = 0;
            }
            else {
    ...
    public class TestTryingToCatchUpGame {
        [Test]
        public void GameTryingToCatchUp() {
            TryingToCatchUpGame game = new();
            Task.Run(async () => {
